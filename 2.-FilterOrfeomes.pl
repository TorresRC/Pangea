...
$Usage = "\tUsage: FilterOrfeomes.pl <Project_Name> <List_File.ext> <Trusted_ORFeome.fasta>\n";
unless(@ARGV) {
        print $Usage;
        exit;
}
...
my ($MainPath, $Project, $ORFeomesPath, $MainList, $SeqExt, $Qry, $InputFile, $cmd, $LogFile, $FilteredORFsPath,
